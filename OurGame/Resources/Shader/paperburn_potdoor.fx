#ifndef _POTDOOR_PAPER_BURN_FX_
#define _POTDOOR_PAPER_BURN_FX_
...
float4 PS_Main(VS_OUT _in) : SV_Target
{
    ...
    float3 materialColor = float3(1.f, 0.2f, 0.2f);
    ...
    float alpha = 1;
    if (finalColorWithBurn.r == 0 && finalColorWithBurn.g == 0 && finalColorWithBurn.b == 0)
        discard;
