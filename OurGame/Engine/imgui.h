...
struct ImVec2
{
    ...
    ImVec2 operator* (const ImVec2& other) const { return ImVec2(other.x * x, other.y * y); }

    ImVec2 operator* (float other) { return ImVec2(other * x, other * y); }
    ImVec2 operator* (float other) const { return ImVec2(other * x, other * y); }

    ImVec2 operator/ (float other) { return ImVec2(x / other, y / other); }
    ImVec2 operator/ (float other) const { return ImVec2(x / other, y / other); }
    ...
    ImVec2& operator+= (float other) { x += other; y += other; return *this; }
    ImVec2& operator-= (float other) { x -= other; y -= other; return *this; }
    ImVec2& operator*= (float other) { x *= other; y *= other; return *this; }
    ImVec2& operator/= (float other) { x /= other; y /= other; return *this; }
...
struct ImVec4
{
    ...
    ImVec4 operator* (const ImVec4& other) { return ImVec4(other.x * x, other.y * y, other.z * z, other.w * w); }
    ImVec4 operator* (const ImVec4& other) const { return ImVec4(other.x * x, other.y * y, other.z * z, other.w * w); }

    ImVec4 operator* (float other) { return ImVec4(other * x, other * y, z * other, w * other); }
    ImVec4 operator* (float other) const { return ImVec4(other * x, other * y, z * other, w * other); }

    ImVec4 operator/ (float other) { return ImVec4(x / other, y / other, z / other, w / other); }
    ImVec4 operator/ (float other) const { return ImVec4(x / other, y / other, z / other, w / other); }

    ImVec4 operator/ (const ImVec4& other) { return ImVec4(x / other.x, y / other.y, z / other.z, w / other.w); }
    ...
    ImVec4& operator+= (const ImVec4& other) { x += other.x; y += other.y; return *this; }
    ImVec4& operator-= (const ImVec4& other) { x -= other.x; y -= other.y; return *this; }
    ImVec4& operator*= (const ImVec4& other) { x *= other.x; y *= other.y; return *this; }
    ImVec4& operator/= (const ImVec4& other) { x /= other.x; y /= other.y; return *this; }

    ImVec4& operator+= (float other) { x += other; y += other; return *this; }
    ImVec4& operator-= (float other) { x -= other; y -= other; return *this; }
    ImVec4& operator*= (float other) { x *= other; y *= other; return *this; }
    ImVec4& operator/= (float other) { x /= other; y /= other; return *this; }
