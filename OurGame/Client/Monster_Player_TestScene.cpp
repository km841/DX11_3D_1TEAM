...
namespace hm {
	...
	void Monster_Player_TestScene::Enter()
	{
		...
		// 1층 바닥 - Floor
		{
			...
			info.size = Vec3(100.f, 0.1f, 100.f);
		...
		// 최종보스
		{
			...
			pLordOfDoorRoll->GetTransform()->SetRotation(Vec3(-90.f, 360.f, 360.f));
			...
			pLordOfDoor->GetTransform()->SetRotation(Vec3(-90.f, 360.f, 360.f));
