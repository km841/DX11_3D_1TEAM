...
namespace yj
{
	...
	void HpUi::AddHpUI()
	{
		...
		Interface* pHpContainerFrame = Factory::CreateInterface<Interface>(Vec3::Zero, Vec2(120.f, 15.f), L"..\\Resources\\Texture\\HpContainerFrame.png");
	...
	void HpUi::HpDecrease()
	{
		...
		case 3:
			...
			mpHpIn[1]->SetColor(Vec3::Color(181, 235, 84));
			mpHpIn[0]->SetColor(Vec3::Color(181, 235, 84));
			break;
		}
		if (GetPlayerHp() > 1)
		{
